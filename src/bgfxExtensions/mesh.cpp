...
#define BGFX_CHUNK_MAGIC_PRI BX_MAKEFOURCC('P', 'R', 'I', 0x0)
	...
	bx::AllocatorI* allocator = iocContainerHelper::getAllocator();
...
{
	bx::FileReaderI* reader = iocContainerHelper::getFileReader();
...
{
	MeshState* state = (MeshState*)BX_ALLOC(iocContainerHelper::getAllocator(), sizeof(MeshState) );
	return state;
}

void meshStateDestroy(MeshState* _meshState)
{
	BX_FREE(iocContainerHelper::getAllocator(), _meshState);
}
